...
import { X, ArrowDownCircle, Loader2, Phone, CheckCircle, XCircle } from 'lucide-react';
...
function DepositModal({ onClose, onSuccess }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const result = await initiateDeposit(phoneNumber, num, user?.id || 1);
            ...
            if (result.success) {
                ...
                if (transaction.status === 'success') {
                    setStatus('success');
                    setMessage('Deposit successful! Balance updated.');
                    setTimeout(() => {
        ...
        <div className="fixed inset-0 bg-black z-50 flex flex-col animate-slide-up">
            ...
            <div className="flex items-center justify-between p-6">
                ...
                <div className="text-center">
                    ...
                    <p className="text-xs text-green-500 font-medium">M-Pesa → Deriv</p>
                </div>
                <div className="w-10" />
            </div>
            ...
            <div className="flex-1 flex flex-col max-w-md mx-auto w-full px-6">
                ...
                <div className="flex-1 flex flex-col items-center justify-center">
                    ...
                    <div className="flex items-baseline gap-1 mb-8">
                        <span className="text-4xl text-green-500 font-medium">$</span>
                    ...
                    {/* Phone Input */}
                    <div className="w-full bg-gray-900/50 rounded-2xl p-1 border border-gray-800 focus-within:border-green-500/50 transition-colors mb-6">
                ...
                <button
                    ...
                    className="w-full py-4 bg-green-600 hover:bg-green-500 rounded-2xl text-white font-bold text-lg shadow-lg shadow-green-900/20 active:scale-95 transition-all flex items-center justify-center gap-2 mb-4"
